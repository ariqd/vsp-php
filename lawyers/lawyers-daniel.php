            ...
            <div class="section">
                ...
                <div class="row py-5">
                    <div class="col-md-5">
                        ...
                        <h4 class="mt-4"><span class="red">Daniel Nainggolan, S.H.</span></h4>
                        <p><b>
                                Advocate
                            </b></p>
                        <div class="mt-5">
                    ...
                    <div class="col-md-7">
                        <p>
                            Daniel Nainggolan, S.H  graduated from faculty of law, Padjadjaran University (Bandung) in 2014  where he specialized in criminal law.
                            <br><br>
                            While at University, Daniel was active in BPM (Badan Perwakilan Mahasiswa). He aslco active in eksternal campus Organization such as GMKI (World Student Christian Movement)
                            <br><br>
                            Prior to joining our team in 2017, Maria worked at another prominent law firm in Bandung. His spesialization is commercial litigation, Employment Law, and Bankruptcy.
                            <br><br>
                            Daniel passed the bar exam in 2016 and he is a member of the Indonesian Advocates Association (Peradi).
                            <br><br>
