          ...
          <div class="col-lg-12">
              <div class="section">
                  <div class="row">
                      ...
                      <div class="col-lg-12">
                          <div class="mt-4">
                              <h2 style="width:90%">PT KEMBANG 88 MULTIFINANCE <span class="red">BERUSAHA EKSTRA UNTUK MENGUBAH KEPUTUSAN </span>PT BANK NEGARA INDONESIA</h2>
                          </div>
                      </div>
                  </div>
                  <div class="row mt-4">
                      <div class="col-lg-6 pr-5">
                              ...
                              Perusahaan  pembiayaan PT Kembang 88 Multifinance berusaha ekstra
                              untuk mengubah keputusan PT Bank Negara Indonesia (Persero) Tbk.
                              agar menyetujui proposal perdamaian.<br><br>
                              </p>
                              <p class="text-small">
