          ...
          <div class="col-lg-12">
              <div class="section">
                  <div class="row">
                      ...
                      <div class="col-lg-12">
                          <div class="mt-4">
                              <h2 style="width:90%">PT KEMBANG 88 MULTIFINANCE <span class="red">SIAP MELADENI PERMOHONAN KASASI</span> YANG DIAJUKAN OLEH DUA KREDITURNYA PT BANK MANDIRI (PERSERO) TBK DAN PT BRI SYARIAH.</h2>
                          </div>
                      </div>
                  </div>
                  <div class="row mt-4">
                      <div class="col-lg-6 pr-5">
                              ...
                              Kuasa hukum PT Kembang 88 Multifinance (termohon kasasi) Verry Sitorus meminta
                              kedua krediturnya membuktikan adanya persekongkolan antara debitur dan kreditur
                              dalam mencapai proses perdamaian.<br><br>
                              </p>
                              <p class="text-small">
