        ...
        <div class="container-fluid">
            <div class="row">
              <div class="col-lg-12 p-0">
                  <img class="d-block w-100" src="assets/img/client1.png">
              </div>
            </div>
        </div>
...
<!--                                    “I FIRMLY BELIEVE IN THE <span class="red">RULE OF LAW</span> AS THE FOUNDATION FOR ALL OF OUR BASIC RIGHTS.” –SONIA SOTOMAYOR-->
                        ...
                        <div class="row py-5">
                            <div class="col-md-6">
                                ...
                                <h4 class="mt-4"><span class="red">INSOLVENCY & BANKRUPTCY LAW</span></h4>
                              </div>
                            <div class="col-md-6">
...
<!--                                    PT Bali Melka-->
                          ...
                          <div class="row my-5">
                              <div class="col-md-6">
                                  <img src="assets/img/logo-ligation.png" alt="insolvency">
